...
const ProductListing = () => {
  ...
  useEffect(() => {
    const id = setInterval(
      () => setCurrentSearchIndex(i => (i + 1) % searchTexts.length),
      2000
    );
  ...
  const nextStep = () => checkoutStep < 4 && setCheckoutStep(s => s + 1);
  ...
  const getStepTitle = (step: number) =>
    ['Cart', 'Shipping', 'Payment', 'Thank You'][step - 1] || '';

  const calculateTotal = () =>
    selectedProduct ? selectedProduct.price * quantity + 250 : 0;
  ...
  const products: Product[] = [
    ...
    },
    {
      ...
      name: 'Samsung Galaxy A15 - 6.5"',
      fullName:
        'Samsung Galaxy A15 - 6.5" - 128GB ROM - 4GB RAM - Dual SIM - 4G',
      price: 29_499,
      displayPrice: 'KES 29,499',
      image: '/samsung_1.jpg',
      category: 'phone'
    },
    {
      ...
      name: 'Samsung Galaxy A35 5G - 6.6"',
      fullName:
        'Samsung Galaxy A35 5G - 6.6" - 128GB ROM - 6GB RAM - Dual SIM',
      price: 39_585,
      displayPrice: 'KES 39,585',
      image: '/samsung_2.jpg',
      category: 'phone'
  ...
  return (
    <div className="min-h-screen bg-gray-50 font-sans">
                ...
                {[1, 2, 3, 4].map(step => (
                  <div key={step} className="flex items-center min-w-0">
                    <div
                      ...
                      style={{
                        backgroundColor:
                          step <= checkoutStep ? '#2E1065' : '#D1D5DB',
                        color: step <= checkoutStep ? 'white' : '#6B7280'
                      }}
                    >
                      {step < checkoutStep ? (
                    ...
                    <span className="ml-2 text-xs sm:text-sm font-medium whitespace-nowrap text-gray-700">
                      {getStepTitle(step)}
                    </span>
                    {step < 4 && (
                      <div
            ...
            <div className="p-4 sm:p-6 min-h-[500px]">
              ...
              {checkoutStep === 1 && (
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 sm:gap-8">
                  ...
                  <div className="lg:col-span-2 space-y-6">
                    <div className="bg-white border border-gray-200 rounded-lg p-4 sm:p-6 shadow-sm">
                      ...
                      <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 bg-gray-50 p-4 rounded-lg border border-gray-100">
                        ...
                        <button className="p-2 text-red-500 hover:bg-red-50 rounded-full flex-shrink-0">
                          <Trash2 className="w-4 h-4" />
                        </button>
                      </div>
                    </div>
                  ...
                  <div className="bg-white border border-gray-200 rounded-lg p-4 sm:p-6 shadow-sm">
                    ...
                    <button
                      onClick={nextStep}
                      className="w-full text-white py-3 rounded-lg font-semibold mt-6 shadow"
                      style={{ backgroundColor: '#2E1065' }}
                    >
                      PROCEED TO CHECKOUT
                    </button>
              ...
              {checkoutStep === 4 && (
                <div className="text-center py-8 sm:py-12">
                  ...
                  <button
                    onClick={closeCheckout}
                    className="text-white px-8 py-3 rounded-lg font-semibold mt-8 shadow"
                    style={{ backgroundColor: '#2E1065' }}
                  >
                    Continue Shopping
                  </button>
      ...
      <div className="container mx-auto px-4 py-6 max-w-7xl">
        <div
          className="bg-gradient-to-r from-purple-900 to-purple-800 rounded-lg mb-8 px-4 sm:px-6 py-6 sm:py-8"
          style={{ background: 'linear-gradient(to right,#2E1065,#1E0A4D)' }}
        >
          {/* Tabs */}
          <div className="flex flex-wrap justify-center gap-4 sm:gap-8 mb-6 text-white font-semibold">
            <button className="border-b-2 border-white pb-1">Products</button>
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4 mb-4">
            <div className="relative flex-1 max-w-2xl">
              ...
              <div className="absolute left-6 top-1/2 -translate-y-1/2 overflow-hidden h-6">
                <div
                  className="transition-transform duration-500 ease-in-out"
                  style={{ transform: `translateY(-${currentSearchIndex * 24}px)` }}
                >
                  {searchTexts.map((text, i) => (
                    <div key={i} className="h-6 flex items-center text-gray-800">
                      {text}
                    </div>
                  ))}
                </div>
            ...
            <div className="flex gap-2 sm:gap-4">
              <button className="px-4 sm:px-12 py-3 bg-gray-800 text-white rounded-full font-semibold hover:bg-gray-900 flex items-center gap-2">
                <span>🔍</span>
                <span className="hidden sm:inline">Search</span>
              </button>
              <button
                className="px-4 sm:px-6 py-3 bg-white rounded-full font-semibold hover:bg-gray-50 flex items-center gap-2"
                style={{ color: '#2E1065' }}
              >
                <span>📷</span>
        ...
        <div className="flex flex-col lg:flex-row gap-6">
          {/* FILTER SIDEBAR */}
          <aside className="w-full lg:w-64 bg-white rounded-lg shadow-sm p-4 border border-gray-200 flex-shrink-0 h-fit">
            <div className="flex items-center gap-2 mb-4">
              <Filter className="w-4 h-4 text-green-600" />
              <span className="text-base font-semibold text-gray-800">Filter</span>
            </div>
            ...
            {(
              ...
              <div
                key={key}
                className="border-b last:border-b-0 border-gray-100 pb-3 mb-3 last:pb-0 last:mb-0"
              >
                <button
          ...
          <main className="flex-1 min-w-0">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 sm:gap-6">
              {products.map(prod => (
                <div
                  key={prod.id}
                  className="bg-white border border-gray-200 rounded-lg shadow-sm hover:shadow-md transition-shadow overflow-hidden flex flex-col relative"
                >
                  {prod.discount && (
                    <span className="absolute top-2 left-2 bg-red-500 text-white text-xs font-semibold px-2 py-1 rounded-full z-10">
                      {prod.discount}
                  ...
                  <div className="p-4 flex flex-col flex-grow">
                    ...
                    <div className="flex items-center gap-2 mb-2 mt-auto">
                      <span className="font-bold text-xl" style={{ color: '#2E1065' }}>
                        {prod.displayPrice}
                      </span>
                      {prod.originalPrice && (
                    ...
                    <button
                      ...
                      className="w-full text-white py-2 rounded-lg font-semibold hover:bg-purple-800 transition-colors mt-2"
                      style={{ backgroundColor: '#2E1065' }}
                    >
                      Buy Now
                    </button>

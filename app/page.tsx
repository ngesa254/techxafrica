...
// import AiSolutions from '../component/AiSolutions';
// import IotSolutions from '../component/IotSolutions';
// import DevicesSection from '@/component/DevicesSection';
        ...
        return (
          <div className="min-h-screen flex items-center justify-center">
            <div className="text-center">
              ...
              <p className="text-lg text-gray-600">Learn more about TechX Africa and our mission.</p>
            </div>
          </div>
        );
      case 'services':
        return (
          <div className="min-h-screen flex items-center justify-center">
            <div className="text-center">
              ...
              <p className="text-lg text-gray-600">Discover the services we offer to help your business grow.</p>
            </div>
          </div>
        );
      case 'inspired':
        return (
          <div className="min-h-screen flex items-center justify-center">
            <div className="text-center">
              <h1 className="text-4xl font-bold text-gray-800 mb-4">Get Inspired</h1>
              <p className="text-lg text-gray-600">Find inspiration for your next tech project.</p>
            </div>
          </div>
        );
      case 'partner':
        return (
          <div className="min-h-screen flex items-center justify-center">
            <div className="text-center">
              <h1 className="text-4xl font-bold text-gray-800 mb-4">Become a Partner</h1>
              <p className="text-lg text-gray-600">Join our partner network and grow together.</p>
            </div>
          </div>
        );
      default:
